export const errorsDictionary = {
	...
	RECORD_ADDED_OK: { code: 12, status: 200, message: "Producto agregado al carrito" },
	RECORD_ADDED_ERROR: { code: 13, status: 500, message: "Error al agregar el producto" },
	PURCHASE_ERROR: { code: 14, status: 500, message: "Error al realizar la compra" },
};
